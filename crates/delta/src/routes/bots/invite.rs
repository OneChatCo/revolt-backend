...
use onechatsocial_database::Member;
use onechatsocial_database::{util::reference::Reference, Database, User};
use onechatsocial_models::v0;
use onechatsocial_permissions::{
...
mod test {
    ...
    use onechatsocial_database::{events::client::EventV1, Bot, Channel, Server};
    use onechatsocial_models::v0::{self, DataCreateServer};
